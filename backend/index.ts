...
import uploadRouter from "./upload"; // ייבוא נתיב ההעלאה
...
app.get('/api/equipments', (req: Request, res: Response): void => {
  res.send(equipments);
});

// Endpoint לקבלת ציוד לפי מזהה
app.get('/api/equipments/:id', (req: Request, res: Response): void => {
...
app.post('/api/admin/equipments', isAdmin, (req: Request, res: Response): void => {
...
app.put('/api/admin/equipments/:id', isAdmin, (req: Request, res: Response): void => {
  const id = parseInt(req.params.id, 10);
  ...
  equipments[equipmentIndex] = { ...equipments[equipmentIndex], ...req.body };
...
app.put('/borrow/:borrowId/return', isLoggedIn, (req: Request, res: Response): void => {
...
app.get('/borrows/me', isLoggedIn, (req: Request, res: Response): void => {
...
app.get('/admin/borrows', isAdmin, (req: Request, res: Response): void => {
...
app.get('/admin/borrows/overdue', isAdmin, (req: Request, res: Response): void => {
...
app.put('/admin/borrows/:id', isAdmin, (req: Request, res: Response): void => {
...
app.get('/admin/users', isAdmin, (req: Request, res: Response): void => {
  res.send(users);
});
app.delete('/admin/borrows/:id', isAdmin, (req: Request, res: Response): void => {
  const borrowId = parseInt(req.params.id, 10);
